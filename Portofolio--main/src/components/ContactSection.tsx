...
const SOCIAL = [
  {
    name: 'GitHub', href: 'https://github.com/muhammadkamal-1608', color: '#fff',
  ...
  {
    name: 'TikTok', href: 'https://www.tiktok.com/@m44ll', color: '#ff0050',
  ...
  {
    name: 'Instagram', href: 'https://www.instagram.com/kml_0816?igsh=c2UzdG1zMWxtYXY=', color: '#E1306C',
    ...
    <section ref={ref} id="contact" className="py-32 px-4 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <motion.a href="mailto:muhammadkamal0809@gmail.com"
